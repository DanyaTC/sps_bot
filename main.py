...
API_TOKEN = '6909522004:AAGZa1Dd58YNzR_fDCDgFOqlQvrzJQmilw0'
...
def process_project_description_step(message, project_name):
 ...
 markup.add('MindTech Solutions', 'CodeWave Ltd.', 'TechFusion Labs', 'DataPulse Solutions',
...
def message_reply(message):
 ...
 if message.text == "Назад":
    chat_id = message.chat.id
    bot.send_message(chat_id, "Спасибо, что воcпользовались ботом!")
